...
狀態:**草案,待 voho0000 過目核可後動工**。與已發布的 v0.19.1 無關。
日期:2026-06-15
...
- **用藥靠診斷**:med 自帶 `reasonCode`(ER 藥=K92.0、住院藥=R04.2)。同 (院所,日期) 多個 encounter 時,掛到 `reasonCode` 含相同 ICD 的那筆(碼比對去點正規化,K92.0↔K920)。唯一命中才掛。
