...
• 一次只擷取「健康存摺目前切換顯示的那個人」的紀錄；只能擷取你有權檢視的資料——本人，或經健保署眷屬功能同意綁定的眷屬。擷取你無權檢視的他人資料屬違法行為
...
• Captures one person per sync — whoever "My Health Bank" is currently switched to. You may only capture records you are authorized to view: your own, or a dependent you are legitimately bound to via NHI's dependents (眷屬) feature. Capturing records you are not authorized to view is illegal
