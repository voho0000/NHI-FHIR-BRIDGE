(() => {
  ...
  function _renderDataState() {
    ...
    const inSync = localMatches && _backendPatient.state === "present" && _backendPatient.count === _localBundle.count;
    els.pushLocalBtn.disabled = inSync;
    els.pushLocalBtn.title = inSync ? "\u672C\u5730\u8207\u5F8C\u7AEF\u7B46\u6578\u4E00\u81F4\uFF0C\u5DF2\u540C\u6B65" : "";
    els.pushLocalBtn.textContent = inSync ? "\u2713 \u5DF2\u8207\u5F8C\u7AEF\u540C\u6B65" : "\u{1F4E4} \u628A\u672C\u5730 Bundle \u4E0A\u50B3\u5230\u5F8C\u7AEF";
  }
