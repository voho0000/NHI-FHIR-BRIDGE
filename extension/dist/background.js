(() => {
  ...
  function adaptEncounterFromMedExpense2(item, classHint) {
    if (!item || typeof item !== "object") return null;
  ...
  var NHI_API_ENDPOINTS = [
    ...
    // lab dates.
    {
      ...
      adapt: adaptEncounterFromMedExpense2,
