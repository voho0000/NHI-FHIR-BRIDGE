(() => {
  ...
  var NHI_TO_LOINC = {
    ...
    "27021B": "2986-8",
    // 睪丸脂醇放射免疫分析 — Testosterone total [Mass/vol] S/P
    ...
    "12103B": "25700-6",
    // 免疫電泳分析 — Immunofixation for Serum/Plasma
    "12160B": "15189-4",
    // IgG κ/λ
    "12171B": "17351-8",
    // 抗嗜中性球細胞質抗體 (ANCA)
    ...
    "17009B": "19911-7",
    // 一氧化碳肺瀰散量 — DLCO panel (sub-rows routed via
    ...
    "06012C": "24356-8",
    // 尿液一般檢查 panel — Urinalysis Macro Panel (fallback)
    "06013C": "24356-8",
  ...
  var DISPLAY_FIRST_CODES = /* @__PURE__ */ new Set([
    ...
    "06012C",
    // 尿液一般檢查 — full routine UA panel (dipstick + microscopy).
  ...
  var LOINC_MAP = {
    ...
    "sf.color": "6824-7",
    // Color of Body fluid (loinc.org-verified; was 5778-6 = Urine)
    ...
    "sf.wbc": "26466-3",
    // Leukocytes [#/volume] in Body fluid (absolute)
    "sf.neutrophil": "26513-2",
    // Neutrophils/Leukocytes in Body fluid (was non-existent 10328-6)
    "sf.lympho": "11031-2"
    // Lymphocytes/Leukocytes in Body fluid (was 13046-8 = Blood variant)
  };
  var LOINC_DISPLAY = {
        ...
        async (e) => {
          ...
          if (e?.message === SESSION_EXPIRED_ERROR) {
            ...
            await chrome.storage.local.set({
              syncStatus: {
                running: false,
                progress: "\u{1F512} \u5065\u5EB7\u5B58\u647A\u767B\u5165\u903E\u6642 \u2014 \u8ACB\u56DE\u5230\u5065\u5EB7\u5B58\u647A\u5206\u9801\u91CD\u65B0\u767B\u5165\uFF0C\u7136\u5F8C\u518D\u6309\u300C\u53D6\u5F97\u5065\u5EB7\u5B58\u647A\u8CC7\u6599\u300D",
      ...
      chrome.storage.local.get(STORAGE_KEY).then(async (data) => {
        ...
        if (status?.running && lastBeat && Date.now() - lastBeat > STALE_MS) {
          const dead = {
            ...
            running: false,
            phase: "error",
            progress: "\u4E0A\u6B21\u53D6\u5F97\u4E2D\u65B7\u4E86\uFF08\u53EF\u80FD\u56E0\u700F\u89BD\u5668\u80CC\u666F\u4F11\u7720\u6216\u5206\u9801\u95DC\u9589\uFF09\u3002\u8ACB\u91CD\u65B0\u300C\u53D6\u5F97\u5065\u5EB7\u5B58\u647A\u8CC7\u6599\u300D\u3002"
          };
