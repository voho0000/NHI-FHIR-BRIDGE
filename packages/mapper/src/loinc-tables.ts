...
export const NHI_TO_LOINC: Record<string, string> = {
  ...
  "14066C": "80382-5", // 流感病毒抗原 A — Influenza virus A Ag, rapid IA, resp upper
...
const URINALYSIS_ANALYTE_KEYS: Record<string, string> = {
  ...
  上皮細胞: "5787-7",
  "epi cell": "5787-7",
  "epith cell": "5787-7", // "Epith Cell" — the trailing "th" breaks epi/epithelial
  epith: "5787-7",
  epithelial: "5787-7",
  白血球計數: "5821-4",
  紅血球計數: "5808-1",
  wbc: "5821-4", // bare English sediment WBC count (esterase = "wbc esterase"/leukocyte/leu, longer/distinct → still wins)
  rbc: "5808-1", // bare English sediment RBC count (occult blood = blood/潛血/ob, distinct → unaffected)
  細菌: "25145-4",
  bacteria: "25145-4",
  結晶: "5783-6",
  crystal: "5783-6",
